(() => {
    ...
    (() => {
        ...
        window.addEventListener("load", (function(e) {
            if (document.querySelector(".all-news__calendar")) {
                datepicker_min("[data-calendar]", {
                    customMonths: [ "Январь", "Февраль", "Март", "Aпрель", "Май", "Июнь", "Июль", "Август", "Сентябрь", "Октябрь", "Ноябрь", "Декабрь" ],
            ...
            Array.prototype.forEach.call(inputs, (function(input) {
                let label = input.nextElementSibling, labelVal = label.querySelector(".input-file-button-text").innerText;
                input.addEventListener("change", (function(e) {
                    let countFiles = "";
                    if (this.files && this.files.length >= 1) countFiles = this.files.length;
                    if (countFiles) label.querySelector(".input-file-button-text").innerText = "Выбрано файлов: " + countFiles; else label.querySelector(".input-file-button-text").innerText = labelVal;
                }));
            }));
        }));
        window["FLS"] = true;
